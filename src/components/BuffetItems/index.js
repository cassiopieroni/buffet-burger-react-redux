...
const BuffetItems = ({ changeItem, toggleExtraItem, buffetData, currentSelectedItems }) => {
    ...
    return (
        ...
        <StyledSection>
            ...
            <SelectionOfMainItems 
                ...
                mainItems={ { allBreads, allBurgers, allCheeses } }
                currentItemsOnDish={ { bread, burger, cheese } }
            />
