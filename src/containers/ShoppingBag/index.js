...
import { removeProductFromBag, increaseQuantity, decreaseQuantity, confirmProductsOnBag } from '../../store/ducks/shoppingBag';
            ...
            { (products && products.length) ? (
                ...
                <>
                    ...
                    <StyledDiv>
                        ...
                        <NavLink to={'/delivery'} >
                            <StyledButton onClick={ () => dispatch( confirmProductsOnBag()) } >
