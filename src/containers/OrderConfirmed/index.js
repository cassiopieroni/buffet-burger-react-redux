...
const OrderConfirmed = () => {
	...
	if (!confirmedOrder) {
		return (
			<StyledSection>
				...
				<StyledDiv>
					<br />
					<p>Vôce ainda não possui pedidos confirmados!</p>
					<br />
					<p>
						Verifique sua sacola de compras{" "}
						<NavLink to="/shopping-bag">clicando aqui.</NavLink>
					</p>
				</StyledDiv>
			</StyledSection>
		)
	...
	return (
		<StyledSection>
			...
			<StyledDiv>
				<p>
					Número do pedido: <span>xxxxx</span>
				</p>
